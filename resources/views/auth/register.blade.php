                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="matric_number" class="col-md-4 col-form-label text-md-right">{{ __('Staff ID/Matric Number') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="user_type_id" class="col-md-4 col-form-label text-md-right">{{ __('Select User Type') }}</label>
